...
class MathExpression {
    ...
    fun setPrecision(precision: Int): MathExpression {
    ...
    fun setRoundingMode(roundingMode: RoundingMode): MathExpression {
        evaluator.mathContext = MathContext(precision, roundingMode)

        return this
    }

    fun define(name: String, value: Long): MathExpression {
        define(name, value.toString())

        return this
    }

    fun define(name: String, value: Double): MathExpression {
        define(name, value.toString())

        return this
    }

    fun define(name: String, value: BigDecimal): MathExpression {
        define(name, value.toPlainString())

        return this
    }

    fun define(name: String, expression: String): MathExpression {
    ...
    fun addFunction(name: String, function: Function): MathExpression {
        evaluator.addFunction(name, function)

        return this
    }

    fun addFunction(name: String, func: (List<BigDecimal>) -> BigDecimal): MathExpression {
